                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: const[
                      ...
                      Text('  ファイル ＞ 名前を付けて保存 と進み、ファイル名の下にあるドロップダウンリストで『CSV (コンマ区切り) (*.csv)』を選んで、『保存』をクリックしてください。'),
                      SizedBox(height: 5,),
                      Text('LibreOffice Calc',
                        style: TextStyle(fontSize: 18),
                      ),
                      Text('  ファイル(F) ＞ 名前を付けて保存(A)... と進み、開いたダイアログの右下のドロップダウンリストで『テキスト CSV(.csv)』を選んで、『保存(S)』をクリックしてください。'),
                    ],
                  ),
                ),
              ),
